            ...
            <div class="col-sm-8 m-auto">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{route('units.store')}}" method="POST" class="theme-form theme-form-2 mega-form">
                            @csrf
                            <div class="mb-4 row align-items-center">
                                <label class="form-label-title col-sm-3 mb-0">Unit Name<span class="text-danger">*</span></label>
                                <div class="col-sm-9">
                                    <input class="form-control" id="name" name="name" type="text" placeholder="Unit Name">
                                </div>
                                @error('name')
                            ...
                            <div class="mb-4 row align-items-center">
                                ...
                                <div class="col-sm-9">
                                    <input class="form-control" id="slug" name="slug" type="text" readonly placeholder="Unit Slug">
                                </div>
                            </div>
                            <div>
